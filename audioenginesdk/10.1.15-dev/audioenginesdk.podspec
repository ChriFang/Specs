Pod::Spec.new do |s|
	...
	s.source       = {:http => "http://repo.yypm.com/dwbuild/mobile/ios/audioenginesdk/audioenginesdk_dependentsdk_1.6_maint/20190221-63-r2383965//audioenginesdk.zip"}
	
	s.default_subspec = 'audioenginesdk'
	s.subspec 'audioenginesdk' do |ss|
		ss.dependency 'audiocodec', '10.1.6-dev'
